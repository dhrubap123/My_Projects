...
testArea.addEventListener("keypress", timerStart, false);
testArea.addEventListener("input", timerStart, false);
testArea.addEventListener("change", timerStart, false);
